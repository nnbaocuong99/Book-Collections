...
- [Continuous Delivery with Docker and Jenkins`.epub`](https://github.com/nnbaocuong99/Book-Collections/blob/main/DevOps/Continuous%20Delivery%20with%20Docker%20and%20Jenkins.epub)
...
- DevOps Bootcamp`.pdf`
- [DevOps For Beginners - Joseph Joyner`.epub`](https://github.com/nnbaocuong99/Book-Collections/blob/main/DevOps/DevOps%20For%20Beginners%20-%20Joseph%20Joyner.epub)
...
- [Docker for Sysadmins`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/Docker/Docker%20for%20Sysadmins.pdf)
- Docker Hands on - Deploy, Administer Docker Platform`.epub`
- Docker High Performance`.pdf`
- [Docker in Action`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/Docker/Docker%20in%20Action.pdf)
- [Docker in Action Second Edition`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/Docker/Docker_in_Action_Second_Edition.pdf)
...
- [Monitoring Docker`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/Docker/Monitoring%20Docker.pdf)
...
- [John Arundel, Justin Domingus - Cloud Native DevOps with Kubernetes-O'Reilly Media (2019)`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/k8s/Getting%20Started%20with%20Kubernetes%20-%20Second%20Edition.pdf)
...
- [Kubernetes in Action`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/k8s/Kubernetes%20in%20Action.pdf)
- Kubernetes Microservices with Docker`.pdf`
...
- [Linux Networking Cookbook`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/Linux/Linux%20Shell%20Scripting%20Cookbook.pdf)
- Linux Pocket`.pdf`
...
- [Linux_in_Action`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/Linux/Linux_in_Action.pdf)
...
- [Microservices Deployment Cookbook`.pdf`](https://github.com/nnbaocuong99/Book-Collections/blob/main/Microservices/Microservices%20Deployment%20Cookbook.pdf)
